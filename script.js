...
for(let i=0; i<skunk.length; i++){
  skunk[i].addEventListener('mouseover', function(event){
    skunk[i].style.width = '45%'
  })

  skunk[i].addEventListener('mouseout', function(event){
    skunk[i].style.width = '40%'
  })
}
